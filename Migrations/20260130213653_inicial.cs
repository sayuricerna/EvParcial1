        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    MotivoConsulta = table.Column<string>(type: "varchar(300)", unicode: false, maxLength: 300, nullable: false),
                    Diagnostico = table.Column<string>(type: "varchar(500)", unicode: false, maxLength: 500, nullable: true),
                    Tratamiento = table.Column<string>(type: "varchar(500)", unicode: false, maxLength: 500, nullable: true),
            ...
            migrationBuilder.CreateIndex(
                name: "UQ_Medicos_Cedula",
                table: "Medicos",
                column: "Cedula",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_Pacientes_Apellido",
                table: "Pacientes",
                column: "Apellido");

            migrationBuilder.CreateIndex(
                name: "UQ_Pacientes_Cedula",
                table: "Pacientes",
                column: "Cedula",
                unique: true);
        }
